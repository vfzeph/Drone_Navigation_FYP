...
class BasicCNN(BaseFeaturesExtractor):
    """
    CNN feature extractor inspired by the architecture used in AlexNet.
    """
    ...
    def __init__(self, observation_space: gym.spaces.Box, features_dim: int = 256):
        ...
        # Determine the shape of the flattened output
        with th.no_grad():
...
class NatureCNN(BaseFeaturesExtractor):
    """
    CNN feature extractor inspired by the architecture used in the Nature paper.
    """
